...
final class TvSettopBox implements TypeInterface
{
    use DeviceTypeTrait;

    public const string TYPE = 'tv-set-top-box';

    /**
     * the name of the device
     */
    private const string NAME = 'TV SetTop Box';
     ...
     */
    private const string DESCRIPTION = 'a media player which uses a tv as screen';
}
