...
final class Printer implements TypeInterface
{
    use DeviceTypeTrait;

    public const string TYPE = 'printer';

    /**
     * the name of the device
     */
    private const string NAME = 'Printer';
     ...
     */
    private const string DESCRIPTION = 'a printer with a touch screen';
}
