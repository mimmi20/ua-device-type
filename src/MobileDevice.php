...
final class MobileDevice implements TypeInterface
{
    ...
    public const string TYPE = 'mobile-device';

    /**
     * the name of the device
     */
    private const string NAME = 'Mobile Device';
     ...
     */
    private const string DESCRIPTION = 'a general mobile device with its own screen without the ability to make phone calls';
}
