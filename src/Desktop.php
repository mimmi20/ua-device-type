...
final class Desktop implements TypeInterface
{
    use DeviceTypeTrait;
     ...
     */
    private const string NAME = 'Desktop';
     ...
     */
    private const string DESCRIPTION = 'a non-mobile device without its own screen';
}
