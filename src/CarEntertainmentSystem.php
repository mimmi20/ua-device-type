...
final class CarEntertainmentSystem implements TypeInterface
{
    ...
    public const string TYPE = 'car-entertainment-system';

    /**
     * the name of the device
     */
    private const string NAME = 'Car Entertainment System';
     ...
     */
    private const string DESCRIPTION = 'a entertainment device implemented in a car';
}
