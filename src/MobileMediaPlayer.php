...
final class MobileMediaPlayer implements TypeInterface
{
    ...
    public const string TYPE = 'mobile-media-player';

    /**
     * the name of the device
     */
    private const string NAME = 'Mobile Media Player';
     ...
     */
    private const string DESCRIPTION = 'a mobile entertainment device with its own screen without the ability to make phone calls';
}
